...
OUTMAIN="/davidData/genis/impala/qc_mapping_collapse/impalaRef"
BWA_THREADS = 6
...
## added new goat ref with chromosomes names changed (done by Shenglin in /home/shenglin/project/impala/goat_ref_renamed.fa)

configfile:"/davidData/genis/impala/qc_mapping_collapse/scripts/impala_config.yaml"
...
rule trim_fq:
    ...
    # {NGMERGE} -1 {input.fq1} -2 {input.fq2} -t '/' -o {params.basedir} -m 11 -y -g -n {threads} -u 41 -f {params.basedir} ## this was only to map wildebeest
"""
