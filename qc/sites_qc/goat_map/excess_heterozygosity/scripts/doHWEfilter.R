...
prefix <- "/home/genis/impala/localSitesQC/goatMap/inbreedSites2/results/impalaGoatMappedNo1BadNo5DupsOnlyCommonImpalaE6"
...
chrs <- scan("/home/genis/impala/info_files/goatChrsAutoandX.txt", what="ds")
#k <- chr %in% chr1mb
...
allbed <- read.table("/home/genis/impala/localSitesQC/goatMap/allRegionsFiles/allGoatAutoXchrs.bed")
