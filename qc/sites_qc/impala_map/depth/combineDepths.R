...
highdepth <- "/home/casia16/projects/impala/results/depth/highDepth"
lowdepth <- "/home/casia16/projects/impala/results/depth/lowDepth"

#alldepth <- "/home/genis/impala/localSitesQC/depth/output/allDepth"

chrs <- scan("/home/genis/impala/info_files/impalaMap/impalaRefScaff1kb.txt", what="dl")
...
write(tl, paste0(lowdepth,"/allScaffs_lowDepth.depthGlobal"), ncolumns=length(tl), sep="\t")
write(th, paste0(highdepth,"/allScaffs_highDepth.depthGlobal"), ncolumns=length(th), sep="\t")
#write(ta, paste0(alldepth,"/allScaffs_allDepth.depthGlobal"), ncolumns=length(ta), sep="\t")
