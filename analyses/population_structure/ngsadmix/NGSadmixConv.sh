...
#file=$1 # Input file
file=/home/genis/impala/analyses/impalaMap/beagle/impalaV3No1badNo5dupsImpalaMap.beagle.gz
nfile=admixResultImpalaMap
...
out=/home/genis/impala/analyses/impalaMap/ngsadmix/results/$K #output  directory (no /)
